...
namespace NLog.CoreClrHelpers
{
    public static class Extensions
    {

        public static object InvokeMember(this Type t, string methodName, BindingFlags flags, object[] args)
        {
            System.Diagnostics.Debugger.Break();

            MemberInfo[] matches = t.GetMember(methodName, flags);
            return null;
        }
    }
    ...
    {
        internal static Assembly LoadFromPath(string path)
        {
    ...
    public class Environment
    {
        ...
        {
            StringBuilder outputBuffer = new StringBuilder(260);
            int result = SHGetFolderPath(IntPtr.Zero, (int)folder, IntPtr.Zero, 0, outputBuffer);
            if (result == 0)
            {
        ...
        public enum SpecialFolder
        {
            ...
            //     is valid only for Windows NT, Windows 2000, and Windows XP systems.
            CommonPrograms = 23,
            //
            // Summary:
            ...
            //     users. This special folder is valid only for Windows NT systems.
            CommonTemplates = 45,
            //
            // Summary:
            ...
            //     98 systems with Shfolder.dll installed.
            CommonDocuments = 46,
            //
            // Summary:
